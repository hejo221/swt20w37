...
class CatalogDataInitializer implements DataInitializer {
	...
	private static final Logger LOG = LoggerFactory.getLogger(kickstart.datainitializer.CatalogDataInitializer.class);

	private final WineRepository wineRepository;

	CatalogDataInitializer(WineRepository wineRepository) {
	...
	public void initialize() {
		...
		wineRepository.save(new Wine("Candidato Blanco 2019", "candidato", Money.of(29.99, EURO),"white", Wine.WineType.WHITE));
