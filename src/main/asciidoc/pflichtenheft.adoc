...
10. <<GUI Prototyp, GUI Prototyp>>
  * 10.1. <<Überblick: Dialoglandkarte, Überblick: Dialoglandkarte>>
  * 10.2. <<Dialogbeschreibung, Dialogbeschreibung>>
11. <<Datenmodell, Datenmodell>>
  * 11.1. <<Überblick: Klassendiagramm, Überblick: Klassendiagramm>>
  * 11.2. <<Klassen und Enumerationen, Klassen und Enumerationen>>
