...
[[Use_Case_Diagram]]
image::./images/Use_Case_Diagram.png[Use case diagram of Videoshop, 100%, 100%, pdfwidth=100%, title= "Use case diagram of Videoshop", align=center]
...
|Erweiterungen              |1.	Mitarbeiter klickt auf das Navigationselement "Customer".
...
|Vorbedienung(en)           |None
|Erweiterungen              |1.	Mitarbeiter klickt auf das Navigationselement "Weinkatalog".
                             2.	Dem Mitarbeiter werden alle Weine der ausgewählten Kategorie angezeigt.
|Funktionale Anforderungen  | -
|===

[[sequence_diagram_view_catalog]]
image::./images/View_Catalog.png[Sequence diagram: View Catalog, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm: View Catalog", align=center]
