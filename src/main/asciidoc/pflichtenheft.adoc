...
|Erweiterungen              | -
|Funktionale Anforderungen  | <<F0110>> <<F0111>> <<F0112>> <<F0113>> <<F0115>>
|===
...
a|
Das System soll eine Liste von registrierten Benutzern anzeigen und ermöglichen, dass Benutzer mit der Berechtigung Admin anderen Benutzern die Berechtigung Admin geben können, sowie sie anderen Admins entziehen können.
...
:Client_Description: Synonym für den Kunden des Projekts ({company_name})
