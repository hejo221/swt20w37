...
[[Use_Case_Diagram]]
image::./images/Use_Case_Diagram.png[Use case diagram of Videoshop]
...
|Akteure                    |User
|Trigger                    |Loing: Der Benutzer möchte durch Anmelden auf "versteckte" Funktionen zugreifen.
                             Logout: Der Benutzer möchte durch Anmelden auf "versteckte" Funktionen zugreifen.
|Vorbedienung(en)           |Login: Benutzer ist noch nicht authentifiziert.
...
|Wesentliche Schritte       |1.	Mitarbeiter klickt auf das Navigationselement "Customer".
...
|Vorbedienung(en)           |None
|Wesentliche Schritte       |1.	Mitarbeiter klickt auf das Navigationselement "Weinkatalog".
...
image::./images/ViewCatalog.png[Sequenzdiagramm: View Catalog]
...
|Wesentliche Schritte       |1.	Ein Mitarbeiter drückt auf einen angezeigten Eintrag des Katalogs (Wein).
...
image::./images/ViewDetails.png[Sequenzdiagramm: View Product Details]
...
|Vorbedienung(en)           |1.	Der Akteur hat sich beim System authentifiziert (d. H. Ist ein registrierter Benutzer).
                             2.	Der Akteur zeigt die Detailseite einer Wine an.
|Wesentliche Schritte       |1.	Der Akteur gibt eine gewünschte Menge für die ausgewählte Wine ein (1..die Menge in der Lage).
...
image::./images/Add_Product_to_Cart.png[Sequenzdiagramm: Add Product to Cart]
...
|Wesentliche Schritte       |1.	Der Akteur drückt "Warenkorb" in der Navigationsleiste.
...
|Vorbedienung(en)           |1.	Der Akteur ist authentifiziert und hat die Rolle "Employee" im System.
                             2.	Wagen ist nicht leer.
|Wesentliche Schritte       |1.	Der Mitarbeiter hat mindestens einen Artikel in seinen Warenkorb gelegt.
...
|Wesentliche Schritte       |1.	Der Akteur hat sich beim System authentifiziert (d. H. Ist ein registrierter Benutzer).
...
|Vorbedienung(en)           |Der Akteur hat sich beim System authentifiziert (d. H. Ist ein registrierter Benutzer).
|Wesentliche Schritte       |1.	Mitarbeiter wählt "Lager" in der Navigationsleiste.
...
|Vorbedienung(en)           |Der Akteur hat sich beim System authentifiziert (d. H. Ist ein registrierter Benutzer).
|Wesentliche Schritte       |1.	Mitarbeiter wählt "Sorgen" in der Navigationsleiste
...
image::./images/View_Orders.png[Sequenzdiagramm: View Orders]


==== Example for the function of admin
