...
|ID                         |**<<UC00XY>>**
|Name                       |ViewDetails
|Beschreibung               |Hier bekommt man Informationen über eine konkrete Weinsorte inkl. Verfügbarkeit auf dem Lager.
|Akteure                    |User (Employee & Admin)
|Trigger                    |
_Details_: Benutzer:in möchte Details über eine Weinsorte abrufen.
